...
import 'maps.dart'; // Make sure this path is correct
  ...
  Future<void> _updtadeProfile() async {
    ...
    try {
      ...
      if (_image != null) {
        ...
        if (fileSizeInMB > 2) {
          // Show snackbar if file size exceeds 2 MB
        ...
        // Proceed with upload if file size is valid
        request.files.add(await http.MultipartFile.fromPath(
          'image', _image!.path,
          contentType: MediaType('image', '*'), // Allows any image type
        ));
      ...
      if (response.statusCode == 200) {
        ...
        // Parse and save the updated user information
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Text(_mobile, style: GoogleFonts.sourceSans3(
                            fontWeight: FontWeight.w500,
                            color: Colors.black,
                            letterSpacing: 1,
                            fontSize: 12,
                  ...
                  //       SizedBox(width: 15),
                  //       Expanded(child: Text(_address, style: GoogleFonts.sourceSans3(
                  //         fontWeight: FontWeight.w500,
                  //         color: Colors.black,
                  //         letterSpacing: 1,
                  //         fontSize: 12,
