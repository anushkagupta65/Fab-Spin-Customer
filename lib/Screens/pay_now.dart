...
class _PayNowState extends State<PayNow> implements PaymentService {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => BookingConfirmation(
                  bookingId: totalamount.toString(),
  ...
  void handlePaymentSuccessEvent(PaymentSuccessResponse successResponse) {
    ...
    savePaymentDetails(successResponse.orderId.toString(),
        successResponse.paymentId.toString(), totalamount);
  ...
  Future<void> savePaymentDetails(
    ...
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        final url =
            Uri.parse('https://fabspin.org/api/order-amount-paid/${userId}');
